...
export function IconComment({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M14.046 2.242l-4.148-.01h-.002c-4.374 0-7.8 3.427-7.8 7.802 0 4.098 3.186 7.206 7.465 7.37v3.828a.85.85 0 0 0 .12.403.744.744 0 0 0 1.034.229c.199-.132 4.625-3.26 6.596-5.337 1.61-1.683 2.469-3.896 2.467-6.441 0-4.547-3.514-7.851-5.732-7.844zm3.261 12.143c-1.658 1.727-5.134 4.405-6.08 5.088v-3.09a.75.75 0 0 0-.75-.75h-.355c-3.619 0-6.563-2.697-6.563-6.117 0-3.323 2.779-6.052 6.05-6.052l4.146.01c1.71-.003 4.483 2.886 4.483 6.101-.002 2.088-.726 3.952-2.131 5.41z" />
    </svg>
  );
}
